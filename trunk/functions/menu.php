...
function DisplayMenu($Active) {
	...
	$menu[2] = array( "name" => "menuSection03", "description" => "titoli di studio", "page" => "sapSection03.php", "target" => "_self");
	$menu[3] = array( "name" => "menuSection04", "description" => "titoli", "page" => "sapSection04.php", "target" => "_self");
	$menu[4] = array( "name" => "menuSection05", "description" => "esperienze", "page" => "sapSection05.php", "target" => "_self");
